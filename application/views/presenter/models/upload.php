        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <section id="uploadSection">
                    ...
                    <small style="color: red;">You may upload the following file types: Microsoft PowerPoint (.ppt, .pptx, .pdf), Video Files (.mp4, .mp3, .mv4, .mpg, .mov) Image Files (.jpg, .png, .gif)</small>
                </section>
